      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            className="glass-panel p-8 md:p-12 rounded-[2.5rem] grid lg:grid-cols-2 gap-12 items-center relative"
          >
            {/* Decorative blurs behind the glass panel */}
            <div className="absolute top-0 right-0 -mt-20 -mr-20 w-64 h-64 bg-blue-500/20 rounded-full blur-3xl pointer-events-none"></div>
            <div className="absolute bottom-0 left-0 -mb-20 -ml-20 w-64 h-64 bg-purple-500/20 rounded-full blur-3xl pointer-events-none"></div>
